...
(function(w) {
  ...
  w.fastXDM = {
    _id: 0,
    helperUrl: 'https://web.archive.org/web/20220227164836/https://vk.com/js/api/xdmHelper.js',
...
VK.extend(VK, {
  _domain: {
    base: 'https://web.archive.org/web/20220227164836/https://vk.com',
    login: 'https://web.archive.org/web/20220227164836/https://login.vk.com',
    main: 'https://web.archive.org/web/20220227164836/https://oauth.vk.com',
    api: 'https://web.archive.org/web/20220227164836/https://api.vk.com'
  }
}, true);
...
if (!VK.Widgets) {
  ...
  VK.Widgets._constructor = function(widgetUrl, objId, options, params, funcs, defaults, onDone, widgetId, iter) {
    ...
    funcs.updateVersion = function(ver) {
      if (ver > 1) {
        VK.Api.attachScript('//web.archive.org/web/20220227164836/https://vk.com/js/api/openapi_update.js?'+parseInt(ver));
      }
    };
...
if (!VK.Retargeting) {
  VK.Retargeting = {
    ...
    Event: function (event) {
      ...
      (window.Image ? (new Image()) : document.createElement('img')).src = 'https://web.archive.org/web/20220227164836/https://vk.com/rtrg?p=' + this.pixelCode +
    ...
    Add: function (audienceID) {
      ...
      (window.Image ? (new Image()) : document.createElement('img')).src = 'https://web.archive.org/web/20220227164836/https://vk.com/rtrg?p=' + this.pixelCode + '&audience=' + encodeURIComponent(audienceID);
    },
    ProductEvent: function (priceListID, event, params, opts) {
      ...
      var metatagUrl = pData.url.substr(0, 500);
      var metatagTitle = pData.title && pData.title.substr(0, 500) || '';
      var url = 'https://web.archive.org/web/20220227164836/https://vk.com/rtrg';
...
/*
     FILE ARCHIVED ON 16:48:36 Feb 27, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:39:51 Feb 28, 2022.
...
playback timings (ms):
  ...
  esindex: 0.011
  LoadShardBlock: 154.639 (6)
  PetaboxLoader3.datanode: 131.627 (8)
  CDXLines.iter: 15.897 (3)
  load_resource: 84.269 (2)
  PetaboxLoader3.resolve: 63.288 (2)
*/